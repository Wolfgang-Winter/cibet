...
public class CibetPreCollectionRemoveEventListener extends
   ...
   private transient Log log = LogFactory
         .getLog(CibetPreCollectionRemoveEventListener.class);

   protected CibetPreCollectionRemoveEventListener(
