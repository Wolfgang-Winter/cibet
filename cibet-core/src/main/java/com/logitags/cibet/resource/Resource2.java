...
/**
 * Represents a resource that can by controlled by one of the sensors. The
 * content, e.g. target type, of the Resource object depends on the business
 * case:<br>
...
public abstract class Resource2 implements Serializable {
   //
   // /**
   // *
   // */
   ...
   //
   // private static Log log = LogFactory.getLog(Resource2.class);
   //
   // private static ParameterSequenceComparator comparator = new
   // ParameterSequenceComparator();
   //
   // /**
   // * A unique identifier for this resource. The concrete resource
   // * implementations define how this Id is created
   // */
   // private String uniqueId;
   //
   // /**
   // * the type of the target of the resource. Could be a class name, a URL, a
   // * table name, an entity name etc.
   // */
   // private String targetType;
   //
   // /**
   // * Encoded concrete object of this resource. In case of JPA, this is the
   // * encoded persisted object.
   // */
   // @Lob
   // private byte[] target;
   //
   ...
   //
   // /**
   // * Encoded result of the event execution. In case of a method invocation it
   // * is either null, if the invoked method returns void, or the encoded
   // return
   ...
   //
   // /**
   // * flag if the target, the result and the ResourceParameter values of
   // * Resource are encrypted.
   // */
   // private boolean encrypted = false;
   //
   // /**
   // * reference to the secret/key used for encryption or message digest
   // * generation.
   // */
   ...
   //
   // /**
   // * Unencoded result of the event execution. In case of a method invocation
   // * it is either null, if the invoked method returns void, or the return
   // * value of the invoked method.
   // */
   // @Transient
   ...
   //
   // /**
   // * In case the Resource represents a method invocation, this is the Method
   // * reflection object.
   // */
   // @Transient
   ...
   //
   // /**
   // * Concrete object of this resource. In case of JPA, this is the unencoded
   // * persisted object.
   // */
   // @Transient
   ...
   //
   // /**
   // * In case this Resource represents a JDBC request, this list contains the
   ...
   //
   // /**
   // * The invoker history, from where the current control event was called. In
   // * case of a http request this is the IP address from where the request was
   // * sent including proxy IPs. In case of a method invocation or similar,
   // this
   // * is the command stacktrace
   // */
   // @Transient
   ...
   //
   // /**
   // * Resources in archives and DcControllables can be grouped. For JPA
   // * resources the group id is per default 'targetType'-'primaryKeyId'. The
   // * groupId can always be overwritten by users by setting a groupId into the
   ...
   // * @param copy
   // */
   // public Resource2(Resource2 copy) {
   ...
   // * @param params
   // */
   // public Resource2(Class<? extends ResourceHandler> rh, Object targ, Method
   // m, List<ResourceParameter> params) {
   ...
   // * @param o
   // */
   // public Resource2(Class<? extends ResourceHandler> rh, Object o) {
   // resourceHandlerClass = rh.getName();
   // setObject(o);
   ...
   // * @param primaryKey
   // */
   // public Resource2(Class<? extends ResourceHandler> rh, Class<?> target,
   // Object primaryKey) {
   // resourceHandlerClass = rh.getName();
   // setObject(target);
   ...
   // * @param params
   // */
   // public Resource2(Class<? extends ResourceHandler> rh, String sql, String
   // targetType,
   // List<SqlParameter> insUpdColumns, SqlParameter pk, List<ResourceParameter>
   // params) {
   // resourceHandlerClass = rh.getName();
   // object = sql;
   // try {
   ...
   // * @param params
   // */
   // public Resource2(Class<? extends ResourceHandler> rh, String queryToken,
   ...
   // * @param response
   // */
   // public Resource(Class<? extends ResourceHandler> rh, String targ, String
   // meth, HttpServletRequest r,
   ...
   //
   // try {
   // Class<? extends ResourceHandler> rh = (Class<? extends ResourceHandler>)
   // Class
   // .forName(resourceHandlerClass);
   // Constructor<? extends ResourceHandler> constr =
   // rh.getConstructor(Resource2.class);
   ...
   //
   // /**
   // * the Invoker implementation class that is capable to provide an instance
   // * of the object class for executing the controlled event on it.
   // *
   ...
   // if (key == null) {
   // throw new IllegalArgumentException("Failed to add parameter: key is
   // null");
   // }
   // if (value == null) {
   // parameters.add(new ResourceParameter(key, String.class.getName(), null,
   // type, parameters.size() + 1));
   // } else {
   // parameters.add(new ResourceParameter(key, value.getClass().getName(),
   // value, type, parameters.size() + 1));
   // }
   // }
   //
   // /**
   ...
   // if (setColumns == null && getObject() instanceof String) {
   // SqlParser parser = new SqlParser(null, (String) getObject());
   // setColumns = parser.getInsertUpdateColumns();
   // }
   // return setColumns;
   // }
   //
   ...
   // */
   // public void setSetColumns(List<SqlParameter> setColumns) {
   ...
   // Class<?> pkTypeClass = AnnotationUtil.typeFromAnnotation((Class<?>)
   // getObject(), Id.class);
   ...
   // } else {
   // throw new RuntimeException("Failed to cast " + obj + " into type " +
   // toClass);
   // }
   // }
   //
   ...
   // param.setEncodedValue(secProvider.decrypt(param.getEncodedValue(),
   // getKeyReference()));
   // }
   ...
   // primaryKeyId = sqlId.getValue() == null ? null :
   // sqlId.getValue().toString();
   // } else {
   ...
   //
   // /**
   // * A unique identifier for this resource. The resource-specific
   // * ResourceHandler classes define how this Id is created
   // *
   // * @return the uniqueId
   // */
   ...
   //
   // /**
   // * Flag for JPA resource. If this resource is a JPA entity, this flag
   // * signals if dependencies of the entity and the entity itself are all
   // eager
   // * loaded and detached.
   // *
