...
public class EjbDefaultSensorExecutor implements EjbSensorExecutor {

	@Override
	public void proceed(EventMetadata metadata, InvocationContext invocationCtx)
	      throws Throwable {
		CibetInterceptorCallable callable = new CibetInterceptorCallable(
		      metadata, invocationCtx);
		callable.call();
	}
