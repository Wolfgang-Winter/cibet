...
public enum ExecutionStatus {
   ...
   /**
    * the event is not executed but postponed for a first release by a releasing user. A 6-eyes business case has been
    * postponed and assigned to a first user for approval.
    */
   FIRST_POSTPONED,
   ...
   /**
    * a postponed event is not executed but passed back to the originator of the event
    */
   PASSEDBACK,
