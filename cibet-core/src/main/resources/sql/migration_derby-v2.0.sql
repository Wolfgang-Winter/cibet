...
-- cib_dccontrollable
!alter table CIB_DCCONTROLLABLE add DCCONTROLLABLEID1 VARCHAR(255) not null default '?';
...
!rename column CIB_DCCONTROLLABLE.DCCONTROLLABLEID1 to DCCONTROLLABLEID;
!alter table CIB_DCCONTROLLABLE alter column DCCONTROLLABLEID default null;
!alter table CIB_DCCONTROLLABLE add primary key(DCCONTROLLABLEID);
...
-- cib:lockedobject
!alter table CIB_LOCKEDOBJECT add LOCKEDOBJECTID1 VARCHAR(255) not null default '?';
...
!rename column CIB_LOCKEDOBJECT.LOCKEDOBJECTID1 to LOCKEDOBJECTID; 
!alter table CIB_LOCKEDOBJECT alter column LOCKEDOBJECTID default null;
!alter table CIB_LOCKEDOBJECT add primary key(LOCKEDOBJECTID);
