...
!alter table CIB_ARCHIVE add ARCHIVEID1 VARCHAR(255) default '?' not null;
...
!alter table CIB_ARCHIVE modify ARCHIVEID default null;
...
alter table CIB_ARCHIVE add RESOURCEID VARCHAR(255) default '?' not null;
...
alter table CIB_ARCHIVE modify RESOURCEID default null;

-- cib_dccontrollable
!alter table CIB_DCCONTROLLABLE add CONTROLLABLEID VARCHAR(255) default '?' not null;
...
!alter table CIB_DCCONTROLLABLE modify CONTROLLABLEID default null;
...
alter table CIB_CONTROLLABLE add RESOURCEID VARCHAR(255) default '?' not null;
...
alter table CIB_CONTROLLABLE modify RESOURCEID default null;
...
alter table CIB_RESOURCEPARAMETER add PARAMETERID1 VARCHAR(255) default '?' not null;
alter table CIB_RESOURCEPARAMETER add RESOURCEID VARCHAR(255) default '?' not null;
...
alter table CIB_RESOURCEPARAMETER modify PARAMETERID default null;
alter table CIB_RESOURCEPARAMETER modify RESOURCEID default null;
...
-- cib_eventresult
!alter table CIB_EVENTRESULT add EVENTRESULTID1 VARCHAR(255) default '?' not null;
...
!alter table CIB_EVENTRESULT modify EVENTRESULTID default null;
