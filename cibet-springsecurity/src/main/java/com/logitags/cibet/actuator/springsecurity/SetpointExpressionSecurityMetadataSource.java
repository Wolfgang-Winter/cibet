...
public class SetpointExpressionSecurityMetadataSource implements MethodSecurityMetadataSource {
   ...
   public Collection<ConfigAttribute> getAttributes(Object obj) throws IllegalArgumentException {
      ...
      ConfigAttribute preAttr = createPreInvocationAttribute(mi.getRule(CibetMethodInvocation.PREFILTER_RULE),
            mi.getRule(CibetMethodInvocation.PREAUTHORIZE_RULE));
      list.add(preAttr);

      ConfigAttribute postAttr = createPostInvocationAttribute(mi.getRule(CibetMethodInvocation.POSTFILTER_RULE),
