...
-- ----------------------------------------------
--#
--CREATE TABLE CIB_COMPLEXTESTENTITY_CIB_TESTENTITY (CIB_COMPLEXTESTENTITY_ID BIGINT NOT NULL, EAGERLIST_ID BIGINT, LAZYLIST_ID BIGINT);
CREATE TABLE CIB_COMPLEXTESTENTITY (ID BIGINT generated by default as identity, USERID VARCHAR(255), OWNER VARCHAR(255), COMPVALUE INTEGER NOT NULL, TEN_ID BIGINT, VERSION BIGINT NOT NULL);
CREATE TABLE CIB_TCOMPLEXENTITY_EAGER (ID BIGINT NOT NULL, EAGER_ID BIGINT NOT NULL);
CREATE TABLE CIB_TCOMPLEXENTITY_LAZY (ID BIGINT NOT NULL, LAZY_ID BIGINT NOT NULL);
CREATE TABLE CIB_TESTENTITY (ID BIGINT generated by default as identity, NAMEVALUE VARCHAR(255), COUNTER INTEGER NOT NULL, USERID VARCHAR(255), OWNER VARCHAR(255));
...
-- primary/unique
ALTER TABLE CIB_TESTENTITY ADD CONSTRAINT SQL090920190806050 PRIMARY KEY (ID);

ALTER TABLE CIB_COMPLEXTESTENTITY ADD CONSTRAINT SQL090920190805720 PRIMARY KEY (ID);

ALTER TABLE CIB_TCOMPLEXENTITY_EAGER ADD CONSTRAINT SQL090920190805860 PRIMARY KEY (ID, EAGER_ID);

ALTER TABLE CIB_TCOMPLEXENTITY_EAGER ADD CONSTRAINT SQL090920190805861 UNIQUE (EAGER_ID);

ALTER TABLE CIB_TCOMPLEXENTITY_LAZY ADD CONSTRAINT SQL090920190805940 PRIMARY KEY (ID, LAZY_ID);
...
CREATE TABLE CIB_COMPLEXTESTENTITY2 (
        ...
        TEN_ID BIGINT,
        PRIMARY KEY (ID),
        CONSTRAINT FK_SULAJTJM2V4SPADY9JWA45GFH FOREIGN KEY (TEN_ID) REFERENCES CIB_TESTENTITY (ID)
);
